...
public enum AuthenticationError implements DomainError {
    TOKEN_PUBLIC_KEY("authentication.tokenPublicKey", "The public key for a new authentication token could not be found."),
    TOKEN_PRIVATE_KEY("authentication.tokenPrivateKey", "The private key for a new authentication token could not be found."),
