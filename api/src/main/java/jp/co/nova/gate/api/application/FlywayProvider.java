package jp.co.nova.gate.api.application;
...
public class FlywayProvider {
    ...
    static {
        ...
        String url = config.getOptionalValue("javax.sql.DataSource.novaGateApiDs.dataSource.url", String.class)
                .orElse(null);
        String username = config.getOptionalValue("javax.sql.DataSource.novaGateApiDs.dataSource.user", String.class)
                .orElse(null);
        String password = config.getOptionalValue("javax.sql.DataSource.novaGateApiDs.dataSource.password", String.class)
                .orElse(null);
